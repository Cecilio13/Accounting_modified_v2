    ...
    <div class="modal-dialog modal-full" >
      ...
      <div class="modal-content" style="border-radius:0px;background-color:#f4f5f8">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="ModalHeader">Create Invoice Form</h4>
        ...
        <div class="modal-body">
            ...
            <div class="col-md-6" style="padding:30px;">
                    ...
                    <div class="col-md-12" >
                        <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link  active" onclick="showemailtab('0')" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Design</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" onclick="showemailtab('0')" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Content</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" onclick="showemailtab('1')" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Emails</a>
                            </li>
                            <script>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <input type="text" class="form-control" style="width:50%;" placeholder="Please name your template" id="TemplateTitleInput">
                                <input type="hidden" class="form-control" id="TemplateID">
                                ...
                                <div id="colorsettingdiv" class="row" style="margin-top:10px;display:none;">
                                        <div class="col-md-2">
                                                ...
                                                <input type="color" id="color1" value="#4F90BB"  onchange="pickcolor(this)"  onkeyup="pickcolor(this)">
                                                <script>
                                                    var pickedcolor="#4F90BB";
                                                    function pickcolor(e){
                                                        ...
                                                        //id="EmailHeaderCompanyName" id="emailbelowMessage"
                                ...
                                <div id="fontsettingdiv" class="row" style="margin-top:10px;display:none;">
                                    <div class="col-md-12">
                                        <div class="form-inline">
                                                ...
                                                <script>
                                                    var template_font_family="Helvetica";
                                                    var template_font_size="10";
                                                    function setfont(){
                                ...
                                <div id="printsettingdiv" class="row" style="margin-top:10px;display:none;">
                                        <div class="col-md-12">
                                            ...
                                            <script>
                                                var template_margin="0.5in 0in 0.5in 0in";
                            ...
                            <script>
                                $(document).ready(function(){
                                    document.getElementById('checkcompanyregistrationnumber').checked=false;
                                    document.getElementById('checkcompanywebsite').checked=false;
                                    document.getElementById('checkshipping').checked=false;
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    ...
                                    <div class="collapse show" id="contenheader">
                                        <div class="card card-body">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <script>
                                                    var companyname_show="1";
                                                    var compantname="{{$settings_company->company_name}}";
                                                ...
                                                <input type="text" class="form-control" style="width:50%;" value="{{$settings_company->company_name}}" onkeyup="setcomapnynamecontent(this)">
                                                <script>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="text" class="form-control" value="{{$settings_company->company_phone}}" style="width:50%;" onkeyup="setcompanyphone(this)">
                                                <script>
                                                    var phonevalue="{{$settings_company->company_phone}}";
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="text" class="form-control" value="{{$settings_company->company_email}}" style="width:50%;" onkeyup="setcompanyemail(this)">
                                                <script>
                                                        var comemail="{{$settings_company->company_email}}";
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="text" class="form-control" value="" style="width:50%;" onkeyup="setcrn(this)">
                                                <script>
                                                        var crnvalue="";
                                                        function setcrn(e){
                                                            crnvalue=e.value;
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="text" class="form-control" value="{{$settings_company->company_website}}" style="width:50%;" onkeyup="setwebsite(this)">
                                                <script>
                                                        var webistecom="{{$settings_company->company_website}}";
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="text" class="form-control" style="width:50%;" id="Formnameinput" onkeyup="setformtitle(this)">
                                                <script>
                                                        var formtitletemp="";
                                    ...
                                    <div class="collapse" id="contentfooter">
                                        <div class="card card-body">
                                            ...
                                            <div class="row">
                                            <div class="col-md-6">
                                            <textarea class="form-control" rows="3" id="messagetocustomer" onkeyup="footerMessage()"></textarea>
                                            <script>
                                                var footmessage="";
                                                var footmessagesize="10px";
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                <textarea class="form-control" rows="3" id="footertextadd" onkeyup="footerText()"></textarea>
                                                <script>
                                                        var footertext="";
                                                        var footertextsize="10pt";
                            ...
                            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="emailSubject" class="form-control" value="Invoice [Invoice No.] from ECC">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" style="white-space: pre-wrap;" onkeyup="setEmailMessage()" rows="5" id="messagecustomertextarea">Here's your invoice! We appreciate your prompt payment.&#10;&#10;Thanks for your business!&#10;ECC
                                        </textarea>
                                        <script>
            ...
            <div class="col-md-6">
                <div id="formtemplatepage" style="font-family: Helvetica; padding: 0px; font-size: 8px; min-height: 760px;min-width:628px;">
                            ...
                            <div id="header" style="padding-left:20px;margin-bottom:20px;">
                                <div id="headerSec" class="row" style="margin-bottom:10px;margin-left:0px;margin-right:0px;">
                                    ...
                                    <div class="companyAdd1" id="comapnyinformationdiv2" style="display:inline-block;float:left;width:40%;">
                                        <div>
                                            <div id="rhs-companyName" style="font-family: Helvetica; font-size: 14px;">{{$settings_company->company_name}}</div>
                                            <div>
                                            ...
                                            <div style="font-family: Helvetica; font-size: 10px;">
                                                <div id="rhs-phoneNumber" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_phone}}</div>
                                                <div id="rhs-email" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_email}}</div>
                                                <div id="rhs-crn" style="font-family: Helvetica; font-size: 10px;"></div>
                                                <div id="rhs-website" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_website}}</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="header" style="padding-left:20px;margin-bottom:20px;">
                                <div id="headerSec" class="row" style="margin-bottom:10px;margin-left:0px;margin-right:0px;">
                                    ...
                                    <div class="companyAdd1" id="comapnyinformationdiv" style="display:inline-block;float:left;width:40%;">
                                        <div>
                                            <div id="rhs-companyName2" style="font-family: Helvetica; font-size: 14px;">{{$settings_company->company_name}}</div>
                                            <div>
                                                <div id="rhs-addrLine2" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_address}}</div>
                                                <div><span id="rhs-state-zip" style="font-family: Helvetica; font-size: 10px;"></span></div>
                                            </div>
                                            <div style="font-family: Helvetica; font-size: 10px;">
                                                <div id="rhs-phoneNumber2" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_phone}}</div>
                                                <div id="rhs-email2" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_email}}</div>
                                                <div id="rhs-crn2" style="font-family: Helvetica; font-size: 10px;"></div>
                                                <div id="rhs-website2" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_website}}</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="header" style="padding-left:20px;margin-bottom:20px;">
                                <div id="headerSec" class="row" style="margin-bottom:10px;margin-left:0px;margin-right:0px;">
                                    ...
                                    <div class="companyAdd1" id="comapnyinformationdiv3" style="display:inline-block;float:left;width:40%;">
                                        <div>
                                            <div id="rhs-companyName3" style="font-family: Helvetica; font-size: 14px;">{{$settings_company->company_name}}</div>
                                            <div>
                                                <div id="rhs-addrLine3" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_address}}</div>
                                                <div><span id="rhs-state-zip" style="font-family: Helvetica; font-size: 10px;"></span></div>
                                            </div>
                                            <div style="font-family: Helvetica; font-size: 10px;">
                                                <div id="rhs-phoneNumber3" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_phone}}</div>
                                                <div id="rhs-email3" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_email}}</div>
                                                <div id="rhs-crn3" style="font-family: Helvetica; font-size: 10px;"></div>
                                                <div id="rhs-website3" style="font-family: Helvetica; font-size: 10px;">{{$settings_company->company_website}}</div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="tab-content pl-3 p-1" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <div class="float-right">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                        <a class="dropdown-item" href="#" data-toggle="modal" onclick="setFormType('INVOICE')" data-target="#InvoiceFormModal">Invoice</a>
                        <a class="dropdown-item" href="#" data-toggle="modal" onclick="setFormType('ESTIMATE')" data-target="#InvoiceFormModal">Estimate</a>
                        <a class="dropdown-item" href="#" data-toggle="modal" onclick="setFormType('SALES RECEIPT')" data-target="#InvoiceFormModal">Sales Receipt</a>
                    <script>
                        function setFormType(type){
                            ...
                            if(type=="INVOICE"){
                                ...
                                document.getElementById('emailSubject').value="Invoice [Invoice No.] from [Company Name]";
                            }
                                ...
                                document.getElementById('emailSubject').value="Estimate [Estimate No.] from [Company Name]";
                            }
            ...
            <div id="table" class="table-editable">
                ...
                <table id="customformstyletable" class="table table-bordered table-responsive-md table-striped text-left font14 bg-white">
                    <thead>
                    <tr>
                    ...
                    <tbody>
                    @foreach($Formstyle as $fs)
                    <tr>
                        <td class="pt-3-half" contenteditable="false">{{$fs->cfs_name}}</td>
                        <td class="pt-3-half" contenteditable="false">{{$fs->cfs_form_name_value}}</td>
                        <td class="pt-3-half" contenteditable="false">{{date_format($fs->updated_at,"m-d-Y")}}</td>
                        <td class="text-center">
                            <div class="btn-group">
                                <form action="{{ action('FormstyleController@editformstyle') }}" method="POST">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="customformid" value="{{$fs->cfs_id}}">
                                ...
                                <div class="dropdown-menu">
                                    <form action="{{ action('FormstyleController@previewformstyle') }}" method="POST">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden" name="customformid" value="{{$fs->cfs_id}}">
                                        <input type="submit" style="display:none;" class="dropdown-item " value="Preview">
                                    </form>
                                    <form action="{{ action('FormstyleController@editformstyle') }}" method="POST">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden" name="customformid" value="{{$fs->cfs_id}}">
                                        <input type="submit" class="dropdown-item" value="Rename">
                                    </form>
                                    <form action="{{ action('FormstyleController@deleteformstyle') }}" method="POST">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden" name="customformid" value="{{$fs->cfs_id}}">
